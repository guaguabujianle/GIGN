...
# res = glob(os.path.join('./data/toy_set/*/????.rdkit'))
# print(len(res))
...
#         glob(os.path.join(data_root, '*', '*.dgl')) + glob(os.path.join(data_root, '*', '*.rdkit')) + glob(os.path.join(data_root, '*', '*.pyg'))
...
# def copy_files(src_data_dir, dst_data_dir, df, src_graph_type='Graph_IGN', dst_graph_type='Graph_IGN'):
#     for i, row in df.iterrows():
#         pdbid = row['pdbid']
#         pKa = row['-logKd/Ki']
#         src_path = os.path.join(src_data_dir, pdbid, f"{src_graph_type}-{pdbid}_5A.pyg")
#         dst_path = os.path.join(dst_data_dir, pdbid, f"{dst_graph_type}-{pdbid}_5A.dgl")
...
# copy_files(src_train_dir, dst_train_dir, train_df, src_graph_type='Graph_IGN', dst_graph_type='Graph_IGN')
# copy_files(src_train_dir, dst_valid_dir, valid_df, src_graph_type='Graph_IGN', dst_graph_type='Graph_IGN')
# copy_files(src_test2013_dir, dst_test2013_dir, test2013_df, src_graph_type='Graph_IGN', dst_graph_type='Graph_IGN')
# copy_files(src_test2016_dir, dst_test2016_dir, test2016_df, src_graph_type='Graph_IGN', dst_graph_type='Graph_IGN')
# copy_files(src_test2019_dir, dst_test2019_dir, test2019_df, src_graph_type='Graph_IGN', dst_graph_type='Graph_IGN')
