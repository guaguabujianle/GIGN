...
if __name__ == '__main__':
    ...
    valid_set = GraphDataset(valid_dir, valid_df, graph_type='Graph_IGN', create=False)
    test2013_set = GraphDataset(test2013_dir, test2013_df, graph_type='Graph_IGN', create=False)
    test2016_set = GraphDataset(test2016_dir, test2016_df, graph_type='Graph_IGN', create=False)
    test2019_set = GraphDataset(test2019_dir, test2019_df, graph_type='Graph_IGN', create=False)
    ...
    load_model_dict(model, './model/20221121_094401_IGN_repeat0/model/epoch-546, train_loss-0.1136, train_rmse-0.3370, valid_rmse-1.1913, valid_pr-0.7644.pt')
