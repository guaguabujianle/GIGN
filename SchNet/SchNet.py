...
from torch_geometric.nn import MessagePassing, radius_graph, global_add_pool
...
class SchNet(torch.nn.Module):
    ...
    def __init__(
        ...
        self.fc = FC(hidden_channels, hidden_channels, 3, 0.1, 1)
...
if __name__ == '__main__':
    model = SchNet()
    z = torch.LongTensor([0, 2, 1, 0, 3, 0])
    pos = torch.FloatTensor([[0, 1, 1], [1, 0.5, 2], [1, 2, 3], [0, 0, 2], [1.5, 1.5, 0], [3, 2, 2.5]])
    num_nodes = 6
    model(z, pos)
# %%
